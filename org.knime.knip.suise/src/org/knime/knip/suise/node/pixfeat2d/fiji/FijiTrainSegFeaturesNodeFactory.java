 ...
 */
public class FijiTrainSegFeaturesNodeFactory<T extends RealType<T>> extends
    ...
    protected ValueToCellNodeDialog<ImgPlusValue<T>> createNodeDialog() {
        return new FijiTrainSegFeaturesNodeDialog<T>();
    }
    ...
    public ValueToCellNodeModel<ImgPlusValue<T>, ImgPlusCell<FloatType>> createNodeModel() {
        return new FijiTrainSegFeaturesNodeModel<T>();
    }
