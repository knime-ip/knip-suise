 ...
 */
public interface ContourDataClassifier {

    /**
     * @param cData the contour data cluster x instance x feature
     * @param bgData background data cluster x instance x feature
     * @throws Exception
     */
     ...
     * 
     * @param inst
     * @return the probability of the instance of being a contour point
     * @throws Exception
     */
